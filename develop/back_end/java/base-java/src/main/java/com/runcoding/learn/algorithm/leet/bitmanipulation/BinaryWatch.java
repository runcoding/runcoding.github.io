package com.runcoding.learn.algorithm.leet.BitManipulation;// A binary watch has 4 LEDs on the top which represent the hours (0-11), and the 6 LEDs on the bottom represent the minutes (0-59).
